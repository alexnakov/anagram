...
export default function BoardSVG() {
  ...
  return (
    <svg style={{zIndex: '-2'}} width="440px" height="120px">
      {/* This is is the lightbrown big rect */}
      <rect width="440px" height="120" fill="rgb(232, 152, 82)" style={{zIndex: '-2'}}></rect>
      ...
      {[0,1,2,3,4,5,6,7,8].map(v => {
        return (<rect key={v} x={50*v} y="80" width="40" height="40" fill={squareColour} style={{zIndex: "-1"}}></rect>)
      })}
    </svg>
  )
}
